...
for i in range(len(names_list)):
    ...
    date_to_print = str(date.today().strftime("%d/%m/%Y"))   #Change this date as per requirement
    ...
    # use a truetype font  
    font = ImageFont.truetype("./fonts/BndyYlwSolid.TTF", 20)      #You can change fonts from list given bottom
    #font1 = ImageFont.truetype("./fonts/OLDENGL.TTF", 22) 

    # Draw the text 
    draw.text((int(coordinates[0]), int(coordinates[1])), name_to_print, font=font , fill='#ebcc34')
